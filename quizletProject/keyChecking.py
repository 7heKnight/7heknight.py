...
def parser(fileDir):
    ...
    for i in f:
        ...
        afterAfterResult = re.sub(r'[\t]{1,9}', '', afterResult)
        afterAfterResult1 = re.sub(r'[0-9\-\[\]]{2,99}[ ][a-zA-Z0-9]{1,5}]', '', afterAfterResult)
        afterAfterResult2 = re.sub(r'[0-9\-\[\]]{2,99}[ ]', '', afterAfterResult1)
        afterAfterResult3 = re.sub(r'[ ]{2,99}', '', afterAfterResult2)
